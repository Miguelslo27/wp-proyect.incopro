 ...
 * incopro Theme
 */
class incopro_home_parallax extends WP_Widget
{
    function __construct(){

        $widget_ops = array('classname' => 'incopro_home_parallax','description' => esc_html__( "incopro FrontPage Parallax Section" ,'incopro') );
        parent::__construct('incopro_home_parallax', esc_html__('[incopro] Parralax Section For FrontPage','incopro'), $widget_ops);
    }
    ...
    function widget($args , $instance) {
        ...
        $image_pos = isset($instance['image_pos']) ? $instance['image_pos'] : esc_html__('left' , 'incopro');
    ...
    ?>
      ...
      <p>
            <label for="<?php echo $this->get_field_name( 'image_src' ); ?>"><?php _e( 'Image:', 'incopro' ); ?></label>
            ...
            <button id="<?php echo $this->get_field_id('image_src_button'); ?>" class="button button-primary custom_media_button" data-fieldid="<?php echo $this->get_field_id('image_src'); ?>"><?php _e( 'Upload Image','incopro' ); ?></button>
      ...
      <p><label for="<?php echo $this->get_field_id('body_content'); ?>"><?php esc_html_e('Content ','incopro') ?></label>
      ...
      <p><label for="<?php echo $this->get_field_id('image_pos'); ?>"><?php esc_html_e('Image Position ','incopro') ?></label>
      <select name="<?php echo $this->get_field_name('image_pos'); ?>"
              id="<?php $this->get_field_id('image_pos'); ?>" class="widefat">
              <option value="left" <?php selected( $instance['image_pos'], 'left' ); ?>><?php _e('Left', 'incopro'); ?></option>
              <option value="right" <?php selected( $instance['image_pos'], 'right' ); ?>><?php _e('Right', 'incopro'); ?></option>
              <option value="top" <?php selected( $instance['image_pos'], 'top' ); ?>><?php _e('Top', 'incopro'); ?></option>
              <option value="bottom" <?php selected( $instance['image_pos'], 'bottom' ); ?>><?php _e('Bottom', 'incopro'); ?></option>
              <option value="background-full" <?php selected( $instance['image_pos'], 'background-full' ); ?>><?php _e('Background Full', 'incopro'); ?></option>
              <option value="background-small" <?php selected( $instance['image_pos'], 'background-small' ); ?>><?php _e('Background Small', 'incopro'); ?></option>
      </select>
      </p>

      <p><label for="<?php echo $this->get_field_id('button1'); ?>"><?php esc_html_e('Button 1 Text ','incopro') ?></label>
      ...
      <p><label for="<?php echo $this->get_field_id('button1_link'); ?>"><?php esc_html_e('Button 1 Link ','incopro') ?></label>
      ...
      <p><label for="<?php echo $this->get_field_id('button2'); ?>"><?php esc_html_e('Button 2 Text ','incopro') ?></label>
      ...
      <p><label for="<?php echo $this->get_field_id('button2_link'); ?>"><?php esc_html_e('Button 2 Link ','incopro') ?></label>
