 ...
 * incopro Theme
 */
class incopro_home_CFA extends WP_Widget
{
    function __construct(){

        $widget_ops = array('classname' => 'incopro_home_CFA','description' => esc_html__( "[incopro] Call for Action Section" ,'incopro') );
        parent::__construct('incopro_home_CFA', esc_html__('[incopro] Call for Action Section For FrontPage','incopro'), $widget_ops);
    }
    ...
    ?>
      ...
      <p><label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Callout Text ','incopro') ?></label>
      ...
      <p><label for="<?php echo $this->get_field_id('button'); ?>"><?php esc_html_e('Button Text ','incopro') ?></label>
      ...
      <p><label for="<?php echo $this->get_field_id('button_link'); ?>"><?php esc_html_e('Button Link ','incopro') ?></label>
