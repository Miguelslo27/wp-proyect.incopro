 ...
 * incopro Theme
 */
class incopro_home_portfolio extends WP_Widget
{
    function __construct(){

        $widget_ops = array('classname' => 'incopro_home_portfolio','description' => esc_html__( "incopro Porfolio for Home Widget Section" ,'incopro') );
        parent::__construct('incopro_home_portfolio', esc_html__('[incopro] Porfolio for Home Widget Section','incopro'), $widget_ops);
    }
