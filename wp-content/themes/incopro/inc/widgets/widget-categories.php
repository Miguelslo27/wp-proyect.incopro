...
/**
 * [incopro] Categories Widget
 * incopro Theme
 */
class incopro_categories extends WP_Widget
{
	 function __construct(){

        $widget_ops = array('classname' => 'incopro-cats','description' => esc_html__( "incopro Categories" ,'incopro') );
		    parent::__construct('incopro-cats', esc_html__('[incopro] Categories','incopro'), $widget_ops);
    }

    function widget($args , $instance) {
    	extract($args);
        $title = isset($instance['title']) ? $instance['title'] : esc_html__('Categories' , 'incopro');
        $enable_count = '';
    ...
    function form($instance) {
      if(!isset($instance['title'])) $instance['title'] = esc_html__('Categories' , 'incopro');
      ...
      <p><label for="<?php echo $this->get_field_id('limit'); ?>"> <?php esc_html_e('Limit Categories ','incopro') ?></label>
      ...
      <p><label>
        <input  type="checkbox"
         ...
         />
         <?php esc_html_e('Enable Posts Count','incopro') ?></label>
       </p>
