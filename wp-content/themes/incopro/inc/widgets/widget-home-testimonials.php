 ...
 * incopro Theme
 */
class incopro_home_testimonial extends WP_Widget
{
    function __construct(){

        $widget_ops = array('classname' => 'incopro_home_testimonial','description' => esc_html__( "incopro Testimonial Widget Section" ,'incopro') );
        parent::__construct('incopro_home_testimonial', esc_html__('[incopro] Testimonial Section For FrontPage','incopro'), $widget_ops);
    }

    function widget($args , $instance) {
    	extract($args);
        $title = isset($instance['title']) ? $instance['title'] : esc_html__('People just like you are already loving Colorlib', 'incopro');
    ...
    ?>
      ...
      <p><label for="<?php echo $this->get_field_id('limit'); ?>"><?php esc_html_e('Limit ','incopro') ?></label>
      ...
      <p>
        <label for="<?php echo $this->get_field_name( 'image_src' ); ?>"><?php _e( 'Background Parallax Image:', 'incopro' ); ?></label>
