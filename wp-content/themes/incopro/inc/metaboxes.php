...
add_action('add_meta_boxes', 'incopro_add_custom_box');
/**
 * Add Meta Boxes.
 *
 * Add Meta box in page and post post types.
 */
function incopro_add_custom_box()
{
    add_meta_box('post-siderbar-layout', //Unique ID
        __('Select layout for this specific Page only ( Note: This setting only reflects if page Template is set as Default Template and Blog Type Templates.)', 'incopro'), //Title
        'incopro_sidebar_layout', //Callback function
        'page' //show metabox in pages
        );
    add_meta_box('page-siderbar-layout', //Unique ID
        __('Select layout for this specific Post only', 'incopro'), //Title
        'incopro_sidebar_layout', //Callback function
    ...
    if ( class_exists( 'WooCommerce' ) ) {
        add_meta_box('product-siderbar-layout', //Unique ID
            __('Select layout for this specific Product only', 'incopro'), //Title
            'incopro_sidebar_layout', //Callback function
    ...
    if (post_type_exists( 'jetpack-portfolio' ) ) {
        add_meta_box('product-siderbar-layout', //Unique ID
            __('Select layout for this specific Portfolio only', 'incopro'), //Title
            'incopro_sidebar_layout', //Callback function
 ...
 */
function incopro_sidebar_layout()
{
    global $incopro_site_layout, $post;
            ...
            <tr>
                <label class="description"><?php
                    ...
                    <select name="site_layout" id="site_layout">
                        ...
                        foreach( $incopro_site_layout as $key=>$val ) { ?>
...
add_action('save_post', 'incopro_save_custom_meta');
/**
 * save the custom metabox data
 * @hooked to save_post hook
 */
function incopro_save_custom_meta($post_id)
{
    global $incopro_site_layout, $post;
