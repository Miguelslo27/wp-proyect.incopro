...
Theme Name: incopro
Theme URI: http://colorlib.com/wp/incopro/
Version: 1.0.5
Tested up to: WP 4.6
...
-------------------------------------------------------
incopro theme, Copyright 2016 colorlib.com
incopro WordPress theme is distributed under the terms of the GNU GPL
incopro is based on Underscores http://underscores.me/, (C) 2012-2016 Automattic, Inc.
-------------------------------------------------------

== Description ==

incopro is a powerful and versatile one page WordPress theme with pixel perfect design and outstanding functionality. It is by far the most advanced free WordPress theme available today with loads of unmatched customization options. This theme comes with several homepage widgets that can be used to add portfolio, testimonials, parallax sections, your product or service information, call for action and much more.

incopro supports most free and premium WordPress plugins such as WooCommerce, Jetpack, Gravity Forms, Contact Form 7, Yoast SEO, Google Analytics by Yoast and much more.
...
For more detailed incopro theme setup please read documentation: https://colorlib.com/wp/support/incopro/

== Frequently Asked Questions ==

= Does this theme support any plugins? =

incopro includes support for Infinite Scroll, Portfolio, Testimonials, Tiled Galleries for Jetpack.
